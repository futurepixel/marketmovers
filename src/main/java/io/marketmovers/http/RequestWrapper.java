...
public class RequestWrapper {
    ...
    public RequestWrapper(HttpServletRequest request) {
        new RequestWrapper(request, null, false);
    }

    public RequestWrapper(HttpServletResponse response, boolean noCache) {
        new RequestWrapper(null, response, noCache);
    }

    public RequestWrapper(HttpServletRequest request, HttpServletResponse response, boolean noCache) {
